...
const variantStyles = {
  ...
  outline:
    'bg-transparent border-2 border-emerald-600 text-emerald-600 dark:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-950/40 focus:ring-emerald-500',
};
